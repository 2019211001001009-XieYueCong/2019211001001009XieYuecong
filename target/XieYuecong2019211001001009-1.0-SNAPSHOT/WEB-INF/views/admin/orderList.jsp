			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.XieYuecong.model.Order o=(com.XieYuecong.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.XieYuecong.dao.UserDao userDao=new com.XieYuecong.dao.UserDao();
						...
						<%
							...
							String paymentType=com.XieYuecong.model.Payment.findByPaymentId(con,n);
							 %>
